...
#ifndef STATIC_STATIC_CONFIG_HEADER
#define STATIC_STATIC_CONFIG_HEADER
...
struct RuntimeConfig
{
    ...
    std::string RuntimeConfigPath() const;

    std::string StaticPathTo(const std::string& path) const;
    std::string SourcePathTo(const std::string& path) const;
};
...
void EnsureStaticDirectoryWriteable(const RuntimeConfig& config);
